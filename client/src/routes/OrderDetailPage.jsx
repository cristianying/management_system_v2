...
const OrderDetailPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () =>{
      ...
      const order_details = await RestaurantFinder.get(`/api/v1/client_order_details/${id}`, {
    ...
    fetchData();
    }, [id,setOrderProducts,setSelectedOrder])
  ...
  return (
    <div>
      ...
      <div className='main'>
        ...
        {selectedOrder && (
        <>
          <h1 className='text-center display=1'>Order ID: {selectedOrder.order_id}</h1>
