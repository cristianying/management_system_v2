      ...
      <RestaurantsContextProvider>
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={
                !isAuthenticated ? (
                  ...
                  <UpdateRestaurant setAuth={setAuth} />
                )
              }
            />
            <Route
            ...
            />
            <Route
              path="/client_orders/:id"
              element={
                !isAuthenticated ? (
                  <Navigate to="/login" />
                ) : (
                  <OrderDetailPage setAuth={setAuth} />
                )
              }
            />
            <Route
